    ...
    <div className="bg-black mb-[9em]  ">
      <div className="flex flex-col lg:flex-row justify-between lg:px-[5em] items-center w-full lg:p-10 px-4">
        ...
        <div className="flex lg:flex-col font-cocon text-white lg:w-[30%] mb-3 mt-[1em]">
          <h1 className="font-[500] lg:text-[40px] text-[30px]">Personalized</h1>
          <h1 className="text-[#FFFFFF80] font-[500] lg:text-[40px] text-[30px]">Learning</h1>
        </div>

        {/* Image Section */}
        <Image src={Star} alt="star" className="w-20 h-20 object-contain hidden lg:block " />
      ...
      <div className="flex lg:pl-[5em] px-[2em]  lg:px-0">
        ...
        <div>
          <Image src={Star2} alt="" className="mt-[15em] absolute left-0 hidden lg:block"/>
        </div>
        <div className="mx-auto">
          <Image src={Man} alt="" className="rounded-2xl lg:-mb-[7em] -mb-[4em]"/>
        </div>
        <div>
          <Image src={Logo} alt="" className="-mt-[3em] -ml-[2em] hidden lg:block "/>
        </div>
        <div>
