...
export default function Hero() {
  ...
  <div className="flex flex-col gap-16">
    ...
    <div className="relative flex flex-col gap-0">
          <Image src="/images/Star1.png" alt="star1" width={100} height={100} className=" absolute -right-12 -top-12"/>
      <Image  src="/images/hero.png" width={1300} height={622} alt="homepage image"/>
      <Image src="/images/Star2.png" width={100} height={100} className="absolute left-20 -bottom-12" alt="star2" />
      ...
      <Image src="/images/play.png" width={18} height={18} alt="play"/>
          </div>
