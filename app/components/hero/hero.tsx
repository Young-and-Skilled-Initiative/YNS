  ...
  return (
    <div className="md:max-w-7xl mx-auto w-full">
      ...
      <div className='flex flex-row  justify-between'>
        <div className='md:max-w-[847px] mx-auto max-w-[235px]'>
        <div className='flex flex-col gap-8 '>
        <h1 className='font-cocon font-normal text-[30px] leading-[33px] md:text-[74.65px] md:leading-[82.11px] '> <span className='bg-six-color-gradient text-transparent bg-clip-text'>Empowering </span> Students
        <span className="inline-block ">
         ...
         to Excel in the Dynamic World</h1>
         <p className='font-manrope font-normal text-[28px]'>Unlock your potential with innovative learning programs designed for the leaders of tomorrow.</p>
         <div className='flex flex-col gap-6 md:flex-row md:space-x-3'>
         <Button
              variant="primary"
              className="hover:opacity-50 hover:text-slate-200 text-[18px] font-manrope">
              Get started
            </Button>
            <Button
              variant="light"
              className="hover:opacity-70 hover:bg-slate-600  bg-gray-100 font-manrope text-[18px] hover:text-white transition ease-linear duration-100">
              Join the Program
            </Button>
         </div>
        ...
        {/* <div>
    <Image src="/images/hero.svg" width={1300} height={622} alt='hero image' />
        </div> */}
        </div>    
      </div>
      </div>
...
//             Unlock your potential with innovative learning programs designed
//             <br /> for the leaders of tommorrow.
//           </p>
...
//           <Image src="/images/Star1.svg" alt="star1" width={100} height={100} className=" absolute -right-12 hidden md:flex  -top-12"/>
//       <Image  src="/images/hero.png" width={1300} height={622} alt="homepage image"/>

//       <Image src="/images/Star2.svg" width={100} height={100} className="absolute hidden md:flex left-20 -bottom-12" alt="star2" />
