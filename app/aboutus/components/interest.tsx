...
const interest = () => {
  return (
    <div className='  flex justify-center py-[2em] md:py-[4em]  bg-[#F6DEAE] '>
        <div className='  items-center flex flex-col lg:flex-row gap-[3em] px-[5em] lg:px-[5em] '>
        ...
        <div className='flex flex-col md:flex-row  bg-[#98BC6D] gap-[1em] md:gap-[2em] lg:gap-[2em] p-[1em] rounded-[2.5em]'>
