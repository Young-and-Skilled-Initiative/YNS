        ...
        <div className='pt-10 flex flex-col gap-8'>
            ...
            <div className='flex flex-col justify-between items-center md:flex-row gap-1'>
                ...
                <div className='px-8 py-10 flex flex-col gap-9'>
                    ...
                    <p className='text-[16px] text-white font-normal leading-[32px] font-manrope'> Whether you're looking to upskill for your current job or start a new career, we can help.</p>
                    <Image src="/images/inStar1.svg" width={76} height={76} alt="star image" className='absolute right-4  bottom-14'/>
                </div>
                </div>
                ...
                <div className='px-8 py-10 flex flex-col gap-9'>
                    <h1 className='font-bold text-[40px] leading-[44px] font-cocon text-white'>Gaining new skills</h1>
                    <p className='text-[16px] text-white font-normal leading-[32px] font-manrope'> Whether you're looking to upskill for your current job or start a new career, we can help.</p>
                    <Image src="/images/inStar2.svg" width={76} height={76} alt="star image" className='absolute right-4  bottom-14'/>
                </div>
                </div>
